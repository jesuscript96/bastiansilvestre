...
import ShowroomWorkSection from './ShowroomWorkSection';
import { ShowroomWork } from '@/lib/showroom';

interface ShowroomHorizontalSeriesProps {
    works: ShowroomWork[];
    slug: string;
}

export default function ShowroomHorizontalSeries({ works, slug }: ShowroomHorizontalSeriesProps) {
